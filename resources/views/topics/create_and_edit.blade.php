    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="reply_cout-field">Reply_cout</label>
                    <input class="form-control" type="text" name="reply_cout" id="reply_cout-field" value="{{ old('reply_cout', $topic->reply_cout ) }}" />
                </div> 
                <div class="form-group">
